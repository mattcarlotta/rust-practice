...
fn sum() {
    ...
    println!("Exercise D: The sum is {}", sum);
}
...
fn double() {
    ...
    println!("Exercise D: You can double x {} times until x is larger than 500", count);
}
...
fn count(arg: String) {
    ...
    loop {
      ...
      println!("Exercise D: Print arg {} {} times", arg, count);
      count += 1;
    }


    println!("Exercise D: Argument '{}' is not a valid arg", arg); // This will output just a newline at the end for cleanliness.
}